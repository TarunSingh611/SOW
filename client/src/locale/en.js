export default {
  ...
  terms: {
    ...
    content: {
      ...
      text3: "You can use the program FOR FREE for 14 days.",
      text4:
      ...
      text7: "Billing is for one year at a time.",
      text8:
        "The price for 123 Fakturera (offer price SEK 99 per month / ordinary price SEK 159 per month) is for the annual fee Start for one year of use of the program.",
      text9:
        "(When you use the offer price of 99 SEK, the one-year period is calculated from registration.)",
      text10: "All prices are excluding VAT.",
      text11:
        "Offer, stock control, member invoicing, multi-user version and English print are (or can be) additional modules that can be ordered later.",
      text12:
